...
function checkCashRegister(price, cash, cid) {
  ...
  onlyUsefulCashInDrawer = filteredFV[0].inDollars * filteredFV[0].quantity;
  ...
  console.log('Suma środków, które NADAJĄ się do wydania: ', onlyUsefulCashInDrawer); //Elminster White - For now. I must change it.
  console.log('Suma środków: ', summedCashInDrawer); //Elminster White - For now. I must change it.
  console.log('------------------------------------------');
  if (onlyUsefulCashInDrawer < change) {
