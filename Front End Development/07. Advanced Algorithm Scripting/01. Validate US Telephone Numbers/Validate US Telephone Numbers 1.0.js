/*
Working example: https://repl.it/Dtq5/0
...
/^(1\s?)?$/gm   // optional country code 1 with or without space is valid

/^(1\s?)?(\(\d{3}\)|\d{3})$/gm   // 3 numbers inside () but () is totally optional
*/