...
/*
  var side = collectionArray[0][secondArgument];
  console.log(side);
*/
  var result = [];
  var side = collectionArray.forEach(function() {
    
    console.log(collectionArray[0][secondArgument]); 
    console.log([secondArgument]);
    if (collectionArray[0][secondArgument]) {
      result.push('true');
    }
